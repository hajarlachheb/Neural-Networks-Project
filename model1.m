function [trainAcc, valAcc, testAcc] =  model1(hiddenUnits, trainingRatio, validationRatio, testRatio, X, Y, epochs, lr, mc)
%LOGSIGMOID + LOGSIGMOID + MSE
    trainAcc = 0;
    valAcc = 0;
    testAcc = 0;
    numTests = 10;
    for j = 1:numTests
        ...
        net.layers{end}.transferFcn = 'logsig'; % We are defining LogSig that we are supposed to use in our task
        net.performFcn = 'mse'; % We add the MSE requirement
        ...
        net.trainParam.max_fail = 10; % We tried many values and choose 10, because it performs better 
